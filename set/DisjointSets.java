...
public class DisjointSets {
  ...
  public void union(int root1, int root2) {
    //cannot merge a set with itself:
    if (root1 == root2){
      System.out.println("Trying to merge a set with itself");
      return;
    }
    //every root should have a negative number in its position in the array
    if (array[root1] >= 0 || array[root2] >=0 ){
      System.out.println("Trying to do union with something that is not a root!");
      return;
    }
